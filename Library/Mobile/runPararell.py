...
def call_script(run_dir, robot_test_suite, tag, lang, browser, run_name):
...
def parallel_execution(robot_path, robot_test_suite, tag="*", lang="EN", browser="gc"):
    ...
    func = partial(call_script, run_dir, robot_test_suite, tag, lang, browser)
...
if __name__ == "__main__":
    ...
    print "[4] => " + sys.argv[4]
    print "[5] => " + sys.argv[5]
    parallel_execution(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5])
